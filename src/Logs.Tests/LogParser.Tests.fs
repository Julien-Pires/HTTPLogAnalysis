...
module LogParser_Tests =
    ...
    [<InlineData("127.0.0.1 - - [25/Oct/2016:14:49:34 +0200] \"POST /favicon.ico HTTP/2.1\" 404 571 \"http://localhost:8080/\" \"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.59 Safari/537.36\"")>]
    [<InlineData("127.0.0.1 - frank [25/Oct/2016:14:49:34 +0200] \"POST /favicon.ico HTTP/2.1\" 404 571 \"http://localhost:8080/\" \"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.59 Safari/537.36\"")>]
